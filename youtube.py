...
def Api_connect():
    Api_Id = "AIzaSyCDlQMSrUMTQ_0lB6xb48vnmWKaZfKBBos"
...
#upload to mongoDB
client = pymongo.MongoClient("mongodb+srv://swetharajarvss:swethakiran@cluster0.vzt1w.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
def channels_table():
    ...
    for index,row in df_single_channel_detail.iterrows():
        ...
        try:
            ...
            news = f"Your Provided Channel name {"Mr.GK"} is Already Exists"
...
def playlists_table():
    ...
    df_single_playlist_details=pd.DataFrame(single_playlist_details)
...
question=st.selectbox("Select your question",("1. All the videos and the channel_name",
...
if question=="1. All the videos and the channel_name":
...
elif "8. videos published in the year of 2022":
...
elif "9. average duration of all videos in each channels":
...
elif "10. videos with highest number of comments":
